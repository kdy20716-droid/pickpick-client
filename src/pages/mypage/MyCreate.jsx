                ...
                <div key={vote.id} className="my-vote-item">
                  ...
                  <div className="vote-preview">
                    {vote.candidate_a_image ? (
                       <img src={(vote.candidate_a_image?.startsWith('http') ? vote.candidate_a_image : `http://localhost:4000/uploads/${vote.candidate_a_image}`)} alt="a" />
                    ) : <div className="no-img">No Img</div>}
                    <span className="vs-text">VS</span>
                    {vote.candidate_b_image ? (
                       <img src={(vote.candidate_b_image?.startsWith('http') ? vote.candidate_b_image : `http://localhost:4000/uploads/${vote.candidate_b_image}`)} alt="b" />
                    ) : <div className="no-img">No Img</div>}
                  </div>
                </div>
              ))
